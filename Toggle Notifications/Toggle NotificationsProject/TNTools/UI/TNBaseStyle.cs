...
namespace ToggleNotifications.TNTools.UI
{
    ...
    public class TNBaseStyle
    {
        ...
        static void BuildTabs()
        {
            ...
            TabNormal.border = new RectOffset(5, 5, 5, 5);
            TabNormal.padding = new RectOffset(10, 10, 5, 5);
            TabNormal.overflow = new RectOffset(0, 0, 0, 0);
            // big_button.fontSize = 20;
            TabNormal.alignment = TextAnchor.MiddleCenter;
            TabNormal.stretchWidth = true;

            TabNormal.normal.background = AssetsLoader.loadIcon("TabNormal");
            setAllFromNormal(TabNormal);

            TabNormal.hover.background = AssetsLoader.loadIcon("Tab_Hover");
            TabNormal.active.background = AssetsLoader.loadIcon("TabActive");
