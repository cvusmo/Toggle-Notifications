...
public class TNStyles
{
    ...
    {
        return GUILayout.Button(txt, TNBaseStyle.big_button, GUILayout.Height(SquareButton_size), GUILayout.Width(SquareButton_size));
    }

    public static bool SquareButton(Texture2D icon)
    {
        return GUILayout.Button(icon, TNBaseStyle.big_button, GUILayout.Height(SquareButton_size), GUILayout.Width(SquareButton_size));
    }
