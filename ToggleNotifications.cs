...
namespace ToggleNotifications
{
    ...
    public class ToggleNotificationsPlugin : BaseSpaceWarpPlugin
    {
        ...
        private NotificationToggle _notificatorToggle;
        ...
        private Dictionary<string, bool> __initialToggles = new();
        ...
        void Update()
        {
            if (Input.GetKeyUp(KeyCode.LeftAlt) && Input.GetKeyDown(KeyCode.RightControl))
            {
        ...
        {
            _notificationToggle.SetNotificationState
                ("SolarPanelsIneffectiveMessage", solarPanelState);
